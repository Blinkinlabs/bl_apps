...
int main(void)
{
    ...
    SOFTWARE_VERSION_STR = "qorc-sdk/bl_apps/bl_helloworldsw";
    ...
    HAL_usbserial_init2(false, false, 0x1337);        // Start USB serial not using interrupts
    for (int i = 0; i != 4000000; i++) ;   // Give it time to enumerate
    
    dbg_str("\n\n");
    dbg_str( "##########################\n");
    dbg_str( "Blinkinlabs QL-EOS-S3 breakout board LED / User Button Test\n");
    dbg_str( "SW Version: ");
